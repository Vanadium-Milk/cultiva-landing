import { Activity, ArrowRight, Brain, CheckSquare, Cpu, Database, Download, Droplets, FileText, Package, Plug, Power, RotateCcw, Server, Terminal, Usb, User, Wifi, Wrench, X, Sun } from 'lucide-react';
import '../styles.css';
...
const Home = () => {
  return (
    <>
      <Navbar links={[
        {link: "#architecture", name: "Sistema"},
        {link: "#features", name: "Innovación"},
        {link: "#guias", name: "Guías"},
        {link: "#results", name: "Resultados"},
        {link: "/downloads", name: "Descargas"}
        ]} />
      <Hero />
      <Architecture />
      <Innovations />
